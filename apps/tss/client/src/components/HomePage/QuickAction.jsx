  ...
  const actions = [
    {
      ...
      title: "Match Tutor",
      desc: "Find your ideal tutor",
      navigateTo: "/view-tutors",
    },
    {
      icon: <BookOpen size={40} />,
      title: "Book Session",
      desc: "Schedule new session",
      navigateTo: "/404",
    },
    {
      icon: <MessageCircle size={40} />,
      title: "Messages",
      desc: "Chat with your tutor",
      navigateTo: "/404",
    },
    {
...
//   // ✅ LẤY USER + ROLE GIỐNG HOME PAGE
//   const storedUser = localStorage.getItem("user");
//   const user = storedUser ? JSON.parse(storedUser) : null;
//   const role = user?.role; // "student" | "tutor"
...
//       desc: "Find your ideal tutor",
//       navigateTo: "/view-tutors",
//       hideForTutor: true, // ✅ Ẩn cho tutor
//     },
//     {
//       icon: <BookOpen size={40} />,
//       title: "Book Session",
...
//         <div className="grid md:grid-cols-5 gap-10 mt-8">
//           {actions
//             // ✅ LỌC THEO ROLE GIỐNG HOME PAGE
//             .filter((item) => !(role === "tutor" && item.hideForTutor))
//             .map((item, idx) => (
//               <button
//                 key={idx}
//                 onClick={() => {
...
//                   window.scrollTo(0, 0);
//                 }}
//                 className="flex flex-col items-center bg-white shadow-lg rounded-2xl
//                            p-6 h-44 hover:shadow-xl transition-all hover:scale-105"
//               >
//                 <div className="text-[#142b63] mb-3">{item.icon}</div>
